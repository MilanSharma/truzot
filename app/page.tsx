        ...
        <section className="pt-32 pb-20 px-6 max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 bg-gradient-to-r from-slate-900 to-slate-600 bg-clip-text text-transparent">
            ...
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
              without the studio anxiety.
            </span>
          </h1>
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
            No awkward poses, no expensive photographers, no wasted time. Get{" "}
            {PLANS.basic.shots}+ studio-quality headshots delivered in as fast
            as {PLANS.executive.turnaround}.
          </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                ...
                <p className="text-slate-600">
                  Get your headshots delivered to your inbox in under an hour.
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                <div className="w-12 h-12 text-blue-600 mb-4">🔒</div>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-12">
          <div className="max-w-4xl mx-auto text-center px-6">
            ...
            <p className="mt-4 text-blue-100">
              Save hundreds of dollars and get your photos in hours, not weeks.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-slate-600 mb-10">
              Original selfie vs. AI-generated professional headshot. Slide to
              compare.
            </p>
            <ComparisonSlider
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {Object.values(PLANS).map((plan: any) => (
                <div
                  key={plan.id}
                  className={`relative bg-white p-8 rounded-2xl border ${plan.popular ? "border-blue-600 shadow-xl ring-2 ring-blue-50" : "border-slate-200"} transition hover:shadow-lg`}
                >
                  {plan.popular && (
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-center gap-2">
                      ...
                      {plan.shots} AI Headshots
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle size={18} className="text-green-500" />{" "}
                      {plan.styles} Unique Styles
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle size={18} className="text-green-500" />{" "}
                      {plan.resolution}
            ...
            <p className="text-center text-sm text-slate-500 mt-8">
              💳 All plans include a 100% satisfaction guarantee. Pay once, own
              forever.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-slate-700 dark:text-slate-300 mb-4">
                  &ldquo;Got hired after updating my LinkedIn with these
                  headshots. Best $39 I ever spent.&rdquo;
                </p>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
                <div className="flex gap-1 text-yellow-400 mb-4">★★★★★</div>
                <p className="text-slate-700 dark:text-slate-300 mb-4">
                  &ldquo;The team plan saved us thousands vs. a photo studio.
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
                <div className="flex gap-1 text-yellow-400 mb-4">★★★★★</div>
                <p className="text-slate-700 dark:text-slate-300 mb-4">
                  &ldquo;Finally, professional headshots without the awkward
                  studio session. The AI nailed my likeness.&rdquo;
                </p>
                <div className="font-semibold text-slate-900 dark:text-white">
                  Emily
                </div>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-16 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Stop overpaying for headshots.
            </h2>
            <p className="text-lg text-blue-100 mb-8">
              Get studio-quality results for 8x less than a photographer.
            </p>
            <Link
              href="/upload"
