...
export default function AdminDashboard() {
 ...
 confirmText: "Retry",
 confirmStyle: "bg-[var(--indigo)] hover:bg-indigo-700",
 action: async () => {
 const token = await getToken();
 ...
 <button
 onClick={() => fetchOrders()}
 className="px-4 py-2 bg-slate-900 text-[var(--text)] rounded-2xl text-sm font-bold hover:bg-slate-800 transition"
 >
 Refresh
 </button>
 </div>
 ...
 <thead>
 <tr className="bg-[var(--bg)] border-b border-slate-200">
 ...
 <tr
 key={o.id}
 className="border-b border-slate-100 hover:bg-[var(--bg)]"
 >
 ...
 className="px-3 py-1.5 bg-[var(--indigo)] text-[var(--text)] rounded-lg text-xs font-bold hover:bg-indigo-700 transition"
 >
 Retry
 </button>
 )}
 ...
 className="px-3 py-1.5 bg-amber-600 text-[var(--text)] rounded-lg text-xs font-bold hover:bg-amber-700 transition"
 >
 Refund
 </button>
 )}
 ...
 className="px-6 py-3 bg-slate-900 text-[var(--text)] rounded-2xl text-sm font-bold hover:bg-slate-800 transition disabled:opacity-50 flex items-center gap-2"
 >
 {loadingMore ? (
 <>
