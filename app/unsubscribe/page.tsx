            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 divide-y divide-slate-100 dark:divide-slate-800">
              <div className="p-6 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-12 h-7 rounded-full transition ${marketing ? "bg-blue-600" : "bg-slate-300"}`}
                  role="switch"
              ...
              <div className="p-6 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-12 h-7 rounded-full transition ${productUpdates ? "bg-blue-600" : "bg-slate-300"}`}
                  role="switch"
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  disabled={saving}
                  className="px-6 py-2.5 bg-blue-600 text-white rounded-xl text-sm font-bold hover:bg-blue-700 transition disabled:opacity-50"
                >
