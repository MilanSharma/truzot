      ...
      <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; color: #0a0a0a;">
        <div style="padding: 40px 0 20px;">
          ...
          <p style="color: #6b6560; font-size: 16px; line-height: 1.6; margin: 0 0 32px;">
            We've generated ${shotCount} professional headshots for you. 
            Click below to view and download them all.
          </p>
          <a href="${dashboardUrl}" 
        ...
        <p style="color: #9b9590; font-size: 13px; line-height: 1.6;">
          Your photos will be available for 30 days, then permanently deleted from our servers.
          Download them soon! — The Truzot team
        </p>
      </div>
    `,
  });
      ...
      <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; color: #0a0a0a;">
        <div style="padding: 40px 0 20px;">
          ...
          <p style="color: #6b6560; font-size: 16px; line-height: 1.6; margin: 0 0 16px;">
            Your <strong>${plan.charAt(0).toUpperCase() + plan.slice(1)} plan</strong> order 
            of $${(amount / 100).toFixed(2)} has been received.
          </p>
          <p style="color: #6b6560; font-size: 16px; line-height: 1.6; margin: 0 0 32px;">
            We're now training your AI model. You'll get another email the moment your 
            headshots are ready — usually within 60 minutes.
          </p>
