...
const PROFESSION_TRANSFORMATIONS = [
  {
  ...
  },
  {
    ...
    caption: "Tech startup founder transformation",
  },
  {
    ...
    caption: "Corporate marketing director look",
  },
  {
    ...
    after:
      "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=600&h=750&fit=crop&crop=face",
    caption: "C-suite executive presence",
  },
  {
    profession: "Creative Professional",
    before:
      "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=600&h=750&fit=crop&crop=face",
    after:
      "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&h=750&fit=crop&crop=face",
    caption: "Creative industry professional",
  },
  {
    ...
    caption: "Professional consultant headshot",
  },
];
      ...
      >
        ...
        <section className="py-20 px-6 bg-[var(--bg-secondary)]">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto">
              See how professionals across industries transformed their casual
              photos into studio-quality headshots. Real results from real
              customers.
            </p>
            ...
            <div className="relative max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                {PROFESSION_TRANSFORMATIONS.map((transformation, index) => (
                  <div
                    key={transformation.profession}
                    className="relative group"
                  >
                    <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-xl transition-shadow">
                      <div className="text-sm font-bold text-blue-600 dark:text-blue-400 mb-3">
                        {transformation.profession}
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="relative">
                          <div className="absolute top-2 left-2 bg-slate-800/80 text-white text-xs px-2 py-1 rounded z-10">
                            Before
                          </div>
                          <img
                            src={transformation.before}
                            alt={`Before - ${transformation.profession}`}
                        ...
                        <div className="relative">
                          ...
                          <img
                            ...
                            alt={`After - ${transformation.profession}`}
                            className="w-full aspect-[4/5] object-cover rounded-lg"
                          />
                        </div>
                      </div>
