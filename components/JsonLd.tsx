...
export function ProductSchema() {
  const priceValidUntil = "2027-01-01T00:00:00.000Z";
  ...
  const schema = {
    ...
    // No aggregateRating/review here: this project has no real completed
    // orders or reviews yet. Fabricated ratings in structured data violate
    // Google's structured-data and misrepresentation policies and put both
    // organic rich-result eligibility and the Google Ads account at risk.
    // Add real aggregateRating/review data back once genuine reviews exist.
  };
  return (
    <script
      type="application/ld+json"
