...
export default function ShareButton({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        onClick={copyLink}
        className="flex items-center gap-1.5 px-3 py-1.5 bg-white text-slate-700 rounded-lg text-xs font-bold border border-slate-200 hover:bg-slate-50 transition"
      >
        {copied ? (
