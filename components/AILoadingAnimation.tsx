...
export default function AILoadingAnimation({
 ...
 {/* Main content */}
 <div className="relative bg-[var(--surface)] rounded-3xl border border-[var(--border)] p-8 md:p-12 shadow-2xl">
 ...
 {/* Main icon */}
 <div className="relative w-24 h-24 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-[var(--shadow-md)]">
 {isTraining ? (
 ...
 <div
 className={`flex flex-col items-center p-4 rounded-2xl transition-all duration-500 ${progress > 20 ? "bg-[var(--lime-dim)]" : "bg-[var(--surface2)]/50"}`}
 >
 <Zap
 className={`w-6 h-6 mb-2 ${progress > 20 ? "text-[var(--lime)]" : "text-[var(--text-muted)]"}`}
 />
 ...
 <div
 className={`flex flex-col items-center p-4 rounded-2xl transition-all duration-500 ${progress > 50 ? "bg-indigo-50 " : "bg-[var(--surface2)]/50"}`}
 >
 <Brain
 className={`w-6 h-6 mb-2 ${progress > 50 ? "text-indigo-600" : "text-[var(--text-muted)]"}`}
 />
 <span className="text-xs font-medium text-[var(--text-muted)]">
 Model Training
 </span>
 ...
 <div
 className={`flex flex-col items-center p-4 rounded-2xl transition-all duration-500 ${progress > 80 ? "bg-purple-50 " : "bg-[var(--surface2)]/50"}`}
 >
 <Sparkles
 className={`w-6 h-6 mb-2 ${progress > 80 ? "text-purple-600" : "text-[var(--text-muted)]"}`}
 />
 <span className="text-xs font-medium text-[var(--text-muted)]">
 Finalizing
 </span>
 ...
 <p className="text-sm text-[var(--text-muted)] -[var(--text-muted)]">
 {isTraining
