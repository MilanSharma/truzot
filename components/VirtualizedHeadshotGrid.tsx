...
const HeadshotCard = React.memo(function HeadshotCard({
  ...
  return (
    <div style={style} className="p-3">
      <div
        className={`group relative w-full h-full rounded-2xl overflow-hidden bg-slate-200 transition-all duration-300 shadow-sm border-4 ${
          isSel ? "border-blue-600 ring-4 ring-blue-100" : "border-transparent"
        }`}
      >
        {!loaded && (
