...
export default function StylePage({ style }: StylePageProps) {
 ...
 <div className="inline-flex items-center rounded-full border border-purple-200/60 bg-purple-50/50 backdrop-blur-sm px-4 py-1.5 text-sm font-semibold text-purple-700 mb-6">
