    ...
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 bg-slate-900 text-white px-6 py-4 rounded-2xl shadow-2xl z-50 flex items-center gap-6 border border-slate-700 animate-in slide-in-from-bottom-8">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="px-4 py-2 bg-slate-800 text-white rounded-xl text-xs font-bold hover:bg-slate-700 transition disabled:opacity-30"
        >
          Select Page
        </button>
        <button
        ...
        <button
          onClick={onClear}
          disabled={downloading}
          className="px-4 py-2 bg-slate-800 text-slate-300 rounded-xl text-xs font-bold hover:bg-slate-700 transition disabled:opacity-30"
        >
          Clear
        </button>
      </div>
